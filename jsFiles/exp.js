...
//getting descriptions with emotions for each account/wheel 
...
//getting emotion for attention check 
...
//making sure that descriptions with emotions for each account/wheel preloads first even before preloading screen
...
const correctAnswers = {
        ...
        const attnChk = {
            ...
            preamble: `<div class='parent'>
               <p> For Round ${roundTextHigh}, you'll be spinning this wheel:</p> 
                ...
                <p>Before you continue, please indicate the following: </p>
                <br>
                </div>`,
            questions: [
                {
 ...
 const attnChk_low = {
            type: jsPsychSurveyMultiChoice,
            preamble: `<div class='parent'>
               <p> <strong> For Round ${roundTextLow}, you'll be spinning this wheel: </strong></p> 
                <p>${lowpreviewWheel}</p>
...
p.flowMeasure = {
    ...
    const previousSpinSpun = jsPsych.data.get().last(2).values()[0].spinsSpun;
